<template>
  <div class="wrap">
    <a-form :form="form" @submit="onSubmit" style="width: 482px">
      <label>昵称</label>
      <a-form-item>
        <a-input
          v-decorator="[
      ...
      <a-form-item>
        <a-checkbox
          v-decorator="[
            ...
            {
              rules: [rules:{required:true,message:'必须选中才能注册'},{ validator: handleAgree }],
            },
          ]"
        >
          我同意
        ...
        >
        <a style="float: right; color: #1890ff">已有账号，我要登录</a>
      </a-form-item>
      <a-form-item>

...
export default {
  ...
  methods: {
    ...
    lockPlayer() {
      ...
      this.$refs.playerRef.removeEventListener("mouseover");
      this.$refs.playerRef.removeEventListener("mouseleave");
      this.$refs.lockRef.removeEventListener("mouseover");
      this.$refs.lockRef.removeEventListener("mouseleave");
    },
  },
};
</script>

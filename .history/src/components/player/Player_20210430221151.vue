...
export default {
  ...
  methods: {
    ...
    lockPlayer() {
      console.log("aaa");
      this.$refs.playerRef.removeEventListener("onmouseover", () => {});
      this.$refs.playerRef.removeEventListener("onmouseleave", () => {});
      this.$refs.lockRef.removeEventListener("onmouseover", () => {});
      this.$refs.lockRef.removeEventListener("onmouseleave", () => {});

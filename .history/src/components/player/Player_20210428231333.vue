    ...
    <div class="container">
      <div class="wrap">
        ...
        <div class="ctrl">
          ...
          ></i>
          <p class="open">
            <span @click="$store.commit('togglePanelShow')"></span>
            <a-tooltip :visible="tooltip.show" placement="top">
              <template slot="title">{{ tooltip.title }}</template>
            </a-tooltip>
          </p>
...
export default {
  ...
  computed: {
    listenChange() {
      ...
      return { playList, ready, playState, currentIdx, playMode };
    },
    ...mapState([
      "playList",
      "currentIdx",

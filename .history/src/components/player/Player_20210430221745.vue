...
export default {
  ...
  methods: {
    ...
    lockPlayer() {
      console.log("aaa");
      // this.$refs.playerRef.removeEventListener("mouseover", this.showPlayer);
      // this.$refs.playerRef.removeEventListener("mouseleave", this.hidePlayer);
      // this.$refs.lockRef.removeEventListener("mouseover", this.showPlayer);
      // this.$refs.lockRef.removeEventListener("mouseleave", this.hidePlayer);

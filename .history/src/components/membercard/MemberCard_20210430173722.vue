  ...
  <div v-if="hasToken">
    <div class="n-myinfo">
      ...
      <ul class="dny clearfix">
        <li class="fst">
          <strong class="ellipsis">{{ userDetail.profile?.eventCount }}</strong>
          <span>动态</span>
        </li>
        <li>
          <strong class="ellipsis">{{ userDetail.profile?.follows }}</strong>
          <span>关注</span>
        </li>
        <li class="lst">
          <strong class="ellipsis">{{ userDetail.profile.followeds }}</strong>
          <span>粉丝</span>
        </li>
      </ul>
    </div>

<template>
  <div id="app">
    <a-layout>
      <a-layout-header>
        <div class="wrap">
          <div class="left">
            ...
            >
              <a-menu-item key="mail"> 发现 </a-menu-item>
              <a-menu-item key="app"> 歌单 </a-menu-item>
            </a-menu>
          </div>
          <div class="right">
            <a-input-search placeholder="歌单/歌手/歌曲" />
            <div class="member">
      ...
      <a-layout-footer> Ant Design ©2021 Implement By Vue </a-layout-footer>
    </a-layout>
  </div>
</template>

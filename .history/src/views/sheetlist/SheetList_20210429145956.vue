...
export default {
  ...
  async mounted() {
    ...
    this.setSheets(this.currentPage, this.radioValue, this.cat);
  },
  methods: {
    setSheets(page, order, cat) {
      this.$store.dispatch("setSheets", page, order, cat);
    },
    changePage(page) {
    ...
    changeOrder(e) {
      ...
      this.$store.dispatch("setOrder", this.radioValue);
    },
  },
};
</script>

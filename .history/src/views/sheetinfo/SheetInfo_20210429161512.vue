    ...
    <div class="g-wrap6">
      <div class="m-info clearfix">
        ...
        <div class="cnt">
          <div class="cntc">
            ...
            <div class="user f-cb">
              <a class="face">
                <img :src="sheetDetail.creator ? sheetDetail.creator.avatarUrl :
      ...
      <div class="wy-sec">
        <div class="u-title wy-sec-wrap clearfix">
          ...
          <span class="sub s-fc3">{{ sheetDetail.tracks.length }}首歌</span>
...
export default {
  ...
  mounted() {
    this.setSheetDetail(this.$route.query.id);
  },
  methods: {
    setSheetDetail(id) {

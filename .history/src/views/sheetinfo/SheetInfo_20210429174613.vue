    ...
    <div class="g-wrap6">
      ...
      <div class="wy-sec">
        ...
        <a-table
          ...
          :pagination="false"
        >
          <span slot="playIcon" slot-scope="playIcon">
            <a-icon type="play-circle" style="margin-left: 15px" />
          </span>
          <span slot="icons" slot-scope="icons">
            <span title="添加"><a-icon type="plus" /></span>
            <span title="收藏"><a-icon type="folder-add" /></span>
            <span title="分享"><a-icon type="share-alt" /></span>
          </span>
        </a-table>
      </div>
    </div>
